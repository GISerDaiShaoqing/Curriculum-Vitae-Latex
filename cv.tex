...
\newcommand{\Shaoqing}{\textbf{\Initials. \LastName}}  % For citations
\newcommand{\Email}{sqddai@iue.ac.cn}
\newcommand{\Website}{http://gisersqdai.top/mycv/}
\newcommand{\Phone}{+86(0592)619-0679}
...
%\begin{center}
    ...
    %\includegraphics[scale=0.5]{dsq.png}&
    %{\fontsize{30pt}{0}\selectfont Shaoqing Dai}
    %\end{tabular}
...
\begin{tabular}{p{0.65\textwidth} p{0.35\textwidth}}
    ...
    %{\fontsize{6pt}{0}\selectfont \Affiliation}
    &
    {\fontsize{10pt}{0}\selectfont 
    %\Affiliation \newline
    \Address \newline
