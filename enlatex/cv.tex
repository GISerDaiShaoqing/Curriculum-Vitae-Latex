...
\RequirePackage[left=0.5in,right=0.5in,top=0.8in,bottom=0.8in]{geometry}
...
\newcommand{\mycvitemEDU}[8]{\cvitem{\faCalendarO\hfill{#1}}{\textbf{#2}, \textit{#3}, {#4}\vfill{#5}\vfill{Thesis:}\textit{#6}\vfill{Major in }{#7}\hfill\faMapMarker\ {#8}}}
%\newcommand{\mycvitemEDU}[6]{\cvitem{\faCalendarO\hfill{#1}}{\textbf{#2}, \textit{#3}, {#4}\vfill{Major in }{#5}\hfill\faMapMarker\ {#6}}}
\newcommand{\mycvitemCOM}[5]{\cvitem{\faCalendarO\hfill{#1}}{\textbf{#2}, \textit{#3}, {#4}\vfill{#5}}}
%\newcommand{\mycvitemPP}[3]{\cvitem{\faCalendarO\hfill{#1}}{{#2}\hfill\faMapMarker\ {#3}}}
\newcommand{\mycvitemPP}[2]{\cvitem{\faCalendarO\hfill{#1}}{{#2}}}
%\newcommand{\mycvitemPPl}[3]{\cvitem{\faCalendarO\hfill{#1}}{{#2}\vfill\hfill\faMapMarker\ {#3}}}
\newcommand{\mycvitemPPl}[2]{\cvitem{\faCalendarO\hfill{#1}}{{#2}}}
...
\extrainfo{
	...
	% Email
	\faEnvelope\ \myuline{\href{mailto:shaoqing.dai@outlook.com}{\nolinkurl{shaoqing.dai@outlook.com}}}\\
	% Website
	\faGlobe\ \myurl{http://gisersqdai.top/mycv/}\\
     	% Address
     \faMap\ {129 Luoyu Road Wuhan, Hubei, China}\\
     %Affiliation
     \faBuilding\ {School of Resource and Environmental Sciences, Wuhan University} 
}
% Picture
%\photo[42pt][2pt]{dsq.png}
%\photo[42pt][2pt]{shaoqingdai_n.png}
\photo[42pt][2pt]{banana_me.png}
% Quote
...
\begin{document}
	...
	\input{employment}
     \input{education}
    %\input{education_selected}
	%\vfill
     \input{interests}
     \input{publications}
     %\input{publications_selected}
	\nocite{*}
	...
	%\vfill
     \input{awards}
	 %\input{awards_selected}
     \input{software}
     %\input{software_selected}
	%\input{publications}
     \input{researches}
     %\input{researches_selected}
     \input{presentation}
     %\input{presentation_n5}
     %\input{poster}
	 \input{activities}
	 %\input{activities_selected}
     \input{teaching}
     %\input{language}
     %\input{skills}
