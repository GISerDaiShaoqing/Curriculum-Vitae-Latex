...
\item
    ...
    (\textit{submitted}).
\item
    SD. Zuo, \Shaoqing, XD. Song, CD. Xu, YL. Liao, PQ. Zhao, WY. Chang, Q. Chen, YY. Li, JF. Tang, W. Man, Y. Ren.
    Mechanisms that influence land-surface temperature of trees outside forests determined by combining remote sensing, ground observations, and spatial statistical models. 
    (\textit{MinorRevisions}).
\item
    SD. Zuo, \Shaoqing, Y. Ren, \&  ZW. Yu.
    Quantifying the relationship between the urban form fragmentation and CO$_2$ emission distribution across different spatial resolutions. 
    (\Review).
\item
