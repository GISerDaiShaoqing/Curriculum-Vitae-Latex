...
CV <- create_CV_object(
  data_location = "data/", 
  #data_location = "https://docs.google.com/spreadsheets/d/1kRdIfpCs_6YTUw3iuoy7tU9l_1mNQ_U7AXtFgrB0Qgk/edit?gid=917338460#gid=917338460",
...
Publications-Scientific and Technological Achievements {data-icon=file}
--------------------------------------------------------------------------------

```{r}
CV %<>% print_section('academic_technology')
```
