...
\item
    ...
    \textbf{\textit{China CDC Weekly}} 6(14), 300–304.
    \DOI{10.46234/ccdcw2024.058}. 
    \textbf{[SCI/SSCI, IF=3.5]}.
\item
...
\item
    ...
    春节期间的$PM_{2.5}$污染短期暴露健康效应评估——以长三角地区25个城市为例.
...
\item
    ...
    \textbf{\textit{Proceedings of Spatial Accuracy 2018}}. 80-83.
...
\item
    ...
    \textbf{\textit{Proceedings of Spatial Accuracy 2018}}. 88-90.
    %\DOI{10.1061/9780784481042.028}. 
    \textbf{[EI]}.
\item
    ...
    \textbf{\textit{International Low Impact Development Conference China 2016 : LID Applications in Sponge City Projects}}. 251-260.
    \DOI{10.1061/9780784481042.028}. 
    \textbf{[EI]}.
...
\item
    林玥希, 陆锋, 许正宜, 薛峻峰, {\heiti{戴劭勍}}, 张欣影 (2025).
    农业社会化服务体系与产业升级驱动机制分析——基于价值链理论的实证研究.
    \textbf{\heiti{\textit{资源与产业}}} \textit{27}(05): 139-150.
...
\item
    {\heiti{戴劭勍}}, 江辉仙 (2026).
    春节期间的$PM_{2.5}$污染短期暴露健康效应评估——以长三角地区25个城市为例. 
    \textbf{\heiti{\textit{医学大数据与人工智能应用(教育部101计划核心课程教材)}}} \space 吴息凤、庄贵华、金焰、王超龙、毛琛\space 主编, 北京: 人民卫生出版社. 
    ISBN: 9787117387644.
\item
    史源源, {\heiti{戴劭勍}}, 贾鹏 (2025).
    医疗服务资源配置研究 \& 健康地理学的前沿视角和研究. 
    \textbf{\heiti{\textit{健康地理学}}} \space 贾鹏\space 著, 北京: 高等教育出版社. 
    ISBN: 978-7-04-063403-7.
\item
    {\heiti{戴劭勍}}, 陈志东, 雷璟晗, 王彦文 (2022).
    融合多源异构时空大数据的共享单车骑行友好度评价研究. 
    \textbf{\heiti{\textit{城垣杯·规划决策支持模型设计大赛获奖作品集(2021)}}} \space 北京城市规划设计研究院, 北京城垣数字科技有限责任公司, 世界规划教育组织, 北规院弘都规划建筑设计研究院有限公司 \space 编, 北京: 中国建筑工业出版社. 
    ISBN: 9787112270439. 
\item
...
\begin{enumerate}
\item
   ISLE可穿戴设备健康数据管理平台. V1.0.
    \textit{登记号: 2025SR1194658}. (2025).
\item
...
\subsection*{\texorpdfstring{\faBook\ 科学技术成果}{科学技术成果}}
\begin{enumerate}
\item
    {\heiti{戴劭勍}},赵吴凡, 张欣影, 林芷欣, 史源源. (2025).
    '环境+双碳'数智化平台建设 (路演签约项目).
    \textit{海峡(晋江)科技创新中心有限公司},
    第三届全国博士后创新创业大赛.
\item
    任引, 左舒翟, 花利忠, {\heiti{戴劭勍}}. (2023).
    基于ETKF-3DVAR混合同化的桉树人工林碳固定尺度扩展研究.
    \textit{中国科学院城市环境研究所,厦门理工学院}, 
    \textit{90000890-2349}, 厦门市科技局.
\end{enumerate}
