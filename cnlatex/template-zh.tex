...
\newcommand{\mycvitemEDU}[8]{\cvitem{\faCalendarO\hfill{#1}}{\textbf{#2}, \textit{#3}, {#4}\vfill{#5}\vfill{毕业论文题目:}\textit{#6}\vfill{专业:}{#7}\hfill\faMapMarker\ {#8}}}
...
\extrainfo{
	...
	\faGlobe\ \myurl{http://gisersqdai.top/mycv/}\\
     ...
     \faMap\ {湖北省武汉市珞喻路129号}\\
     %Affiliation
     \faBuilding\ {武汉大学资源与环境科学学院} 
}
% Picture
%\photo[42pt][2pt]{dsq.png}
%\photo[42pt][2pt]{shaoqingdai.png}
\photo[42pt][2pt]{shaoqingdai_new.png}
% Quote
